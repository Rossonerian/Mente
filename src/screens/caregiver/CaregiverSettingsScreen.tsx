...
function SettingsAccessState({ onSwitchRole }: { onSwitchRole: () => void }) { return <SettingsMessageState title="Caregiver sign-in required" body="Sign in with a caregiver account to view and change saved settings." actionLabel="Switch role" onAction={onSwitchRole} />; }
